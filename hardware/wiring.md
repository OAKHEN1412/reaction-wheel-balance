...
| Motor FG (speed pulse output) | **D2 (INT0)** | **Yellow (เหลือง)** | Motor → Mega (input) | open-collector, ใช้ INPUT_PULLUP ภายในของ Mega ไป 5V | แนะนำเพิ่ม pull-up ภายนอก 4.7–10kΩ ไป 5V ถ้า noise เยอะ (internal pull-up ของ AVR ใช้ได้ แต่ค่อนข้างอ่อน) · **วัดจริง: ~70 พัลส์ต่อรอบล้อ** · ไดร์เวอร์ส่ง FG เฉพาะตอนขับมอเตอร์ (หมุนด้วยมือตอน duty 0 ไม่มีพัลส์) |
...
7. ต่อสายควบคุมมอเตอร์ **ตรงจาก Mega ไม่ต้องผ่าน R หรือทรานซิสเตอร์**: Blue(PWM) → D11, White(DIR) → D7, Green(BRAKE) → D6, Yellow(FG) → D2 (ใช้ internal pull-up ของ Mega หรือเพิ่ม pull-up ภายนอก 4.7–10kΩ ไป 5V ถ้า noise เยอะ)
